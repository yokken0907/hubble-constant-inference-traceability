...
## 1.5.5 — pre-publication repository revision
...
- Removed premature public-repository URL and release-date metadata from `CITATION.cff`.
- Added release and post-publication update checklists.
