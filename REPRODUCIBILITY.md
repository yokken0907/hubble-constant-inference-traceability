...
The associated AI-led research report (version v1.7.1-AIRR2) cites fixed scientific archive GitHub Release `v1.7.1` (tag `v1.7.1`; commit `8ada39da3c712923b70bae0c060388180e0f3a82`). Repository version `v1.7.2` updates reader-facing metadata without changing that scientific baseline.
