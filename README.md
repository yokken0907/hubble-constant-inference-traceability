...
REPOSITORY_RELEASE_FILES    = 122 files
HASHED_RELEASE_FILES        = 121 / 121 VERIFIED
...
The public repository URL above has been confirmed and recorded. No Jxiv DOI, Jxiv URL, release URL, persistent identifier, or manuscript publication status is asserted at this stage. Follow [`PUBLICATION_UPDATE_GUIDE.md`](PUBLICATION_UPDATE_GUIDE.md) only after any remaining identifiers actually exist.
...
Use [`CITATION.cff`](CITATION.cff). The public repository URL is recorded there; Jxiv metadata must be added only after the public Jxiv record actually exists. The manuscript should remain the primary scientific source and this repository its associated traceability archive.
