...
Yoshimura (2026) - Public Traceability Archive, Version 1.7.1
=======================================================================
...
Version 1.7.1
-------------
Version 1.7.1 adds a bilingual archive description, excludes pre-Jxiv manuscript submission files, and updates active package and citation metadata. It changes no scientific statement, numerical result, tolerance, evidence classification, or interpretation boundary.
...
MANUSCRIPT_STATUS = NOT_INCLUDED_IN_PRE_JXIV_REPOSITORY_PACKAGE
...
At package-build time, the v1.7.1 tag and release had not been assigned. If identifiers are added later, record only actual public tags, release URLs, Jxiv records, and persistent identifiers.
