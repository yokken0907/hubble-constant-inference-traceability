...
The v1.7.1 package is assembled and verified locally. No `v1.7.1` tag URL,
v1.7.1 release URL, Jxiv URL, Jxiv DOI, or other persistent identifier is
...
4. Create a new `v1.7.1` tag targeting the final verified v1.7.1 commit.
5. Publish a new v1.7.1 Release without replacing historical assets.
6. Record the actual v1.7.1 release URL only after it exists.
...
3. If the v1.7.1 tag or release has actually been published, record its real URL.
...
## v1.7.1 Jxiv submission model

Submit the manuscript without a supplementary ZIP. Cite the public repository
and the version-fixed v1.7.1 snapshot only after the tag resolves publicly. The
