...
`EXTENSION_RUN_COMMAND.txt` preserves an execution command containing `/mnt/data/...`. This is an ephemeral local runtime path, not a public acquisition URL and not a personal user-directory identifier.
